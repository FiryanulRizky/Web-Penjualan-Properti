<div class="column displaybox">
        ...
        <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
            <ul>
                ...
                <li class="is-active"><a href="/profile">Semua Artikel</a></li>
            </ul>
        </nav>
        ...
        <div class="card cardmargin">
            <div class="containerx">
                <div class="subtitle has-text-black-bis containerx">Semua Artikel</div>
                <div class="column tableshow containerx" style="overflow-x: auto">
                    <p class="subtitle has-text-link is-7 is-pulled-right has-text-weight-bold is-uppercase">Total : {{$articles->count()}}</p>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>No</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="/blog/{{$article->id}}/tampil" class="button is-success nounnounderlinebtn" target="_blank"><i class="fas fa-external-link-square-alt"></i></a></td> 
    ...
    <script>
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                Swal.fire(
                    'Tindakan Dibatalkan',
                    'Artikel Anda Tetap Dapat Diakses :)',
                    'info'
                )
            }
        });
