<div class="column displaybox">
    ...
    <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
        <ul>
            ...
            <li class="is-active"><a href="">Kontak User</a></li>
        </ul>
    </nav>
            ...
            <div class="containerx">
                <div class="containerx">
                    <div class="top">
                        ...
                        <span class="has-text-danger">Sudah Lengkap</span> @else
                                    <span class="has-text-success">Belum Lengkap</span> @endif
                                    </span>
                                ...
                                <div class="subtitle is-7">Kontak Detail:<span class="subtitle is-7"> {{$user->email}} | {{$user->phoneNo}}</span></div>
                ...
                <div class="contetnt">
                    <form action="/admin/user/kontak" method="post">
                        @csrf
                        <div class="field">
                            <div class="field">
                                <div class="control">
                            ...
                            <div class="field">
                                <div class="control">
                                    ...
                                    <textarea class="textarea {{ $errors->has('message') ? ' is-danger' : '' }}" placeholder="Masukkan Pesan Anda"
                            ...
                            <div>
                                <div class="field">
                                    <div class="control is-pulled-right">
                                        <button class="button is-primary" type="submit">Kirim Kesan</button>
                                    </div>
                                </div>
                            </div>
                        </div>
