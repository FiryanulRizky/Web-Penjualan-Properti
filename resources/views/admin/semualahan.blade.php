<div class="column displaybox">
    ...
    <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
        <ul>
            ...
            <li class="is-active"><a href="/profil">Semua Lahan</a></li>
        </ul>
    </nav>
    ...
    <div class="card cardmargin">
        <div class="containerx">
            <div class="subtitle has-text-black-bis containerx">Semua Lahan</div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="/admin/{{strtolower($property->property->type)}}/{{$property->id}}/delete" method="post">
                                    @csrf
