                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="/admin/{{strtolower($property->type)}}/{{$property->id}}" class="button is-success nounnounderlinebtn" target="_blank"><i class="fas fa-external-link-square-alt"></i></a></td> 
                            ...
                            <td>
                                <form action="/admin/{{strtolower($property->type)}}/{{$property->id}}/hapus" method="post">
                                    @csrf
