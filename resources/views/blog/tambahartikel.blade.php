...
<section class="hero is-info is-medium is-bold">
    ...
    <span class="container has-text-centered textbox">
            <h1 class="title is-1">Tambah Artikel Baru</h1>
        </span>
</section>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="field">
                                <div class="control">
                                    ...
                                    <input class="input is-primary" type="text" placeholder="Judl Artikel" name="title">
                                </div>
                            ...
                            <div class="filed">
                                <div class="control">
                                    ...
                                    <textarea class="textarea is-primary" placeholder="Konten Artikel" rows="20" name="content"></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="field">
                            ...
                            <div class="filed">
                                    <div class="control">
                                        <button type="submit" class="button is-primary">Tambah Artikel</button>
                                    </div>
                                </div>
                        </form>
                    </div>
