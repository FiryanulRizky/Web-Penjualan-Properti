<div class="column displaybox">
        ...
        <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
            <ul>
                ...
                <li class="is-active"><a href="/profil">Edit Gudang</a></li>
            </ul>
        </nav>
        ...
        <div class="card cardmargin">
            <div class="containerx">
                ...
                <h1 class="title has-text-centered">Edit Gudang</h1>
                                ...
                                <div class="control">
                                    ...
                                    <div class="contetnt">
                                        <div class="row columns">
                                                ...
                                                <div class="column"><img src="/uploads/property/{{ strtolower($warehouse->property->type) }}/{{$image}}" /></div>
                                                @endforeach
                                        </div>
                                    </div>
                                    <br>
