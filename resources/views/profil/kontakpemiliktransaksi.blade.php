<div class="column displaybox">
        ...
        <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="/profil">Kontak Pemilik Transaksi</a></li>
          </ul>
        </nav>
          ...
          <div class="card cardmargin">
            <div class="containerx">
              <div class="containerx">
                <div class="top">
                  <div>
                    ...
                    <div class="address">
                      ...
                      <div class="subtitle is-7 is-pulled-right">Terkait :<span class="subtitle is-7"> <a href="/{{strtolower($offer->property->type)}}/{{$offer->id}}" target="_blank">Lihat Properti</a></span>
                        <br> 
                ...
                <div class="contetnt">
                  <form action="/profile/transaksi/kontak/pemilik/kirim" method="post">
                    @csrf
                    <div class="field">
                      <div class="field-body">
                        <div class="field">
                          <div class="control">
                            ...
                            <input type="hidden" value="/{{strtolower($offer->property->type)}}/{{ $offer->id }}" name="path">
